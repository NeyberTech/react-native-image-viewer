...
var ImageViewer = /** @class */ (function (_super) {
    ...
    function ImageViewer() {
        ...
        _this.onMoveCompensate = function (index) {
            _this.imageRefs[index] && _this.imageRefs[index].imageDidMove();
        };
        /**
        * 预加载图片
        */
        ...
        _this.goBack = function () {
            ...
            _this.setState({
                ...
                if (_this.props.onChange) {
                    ...
                    _this.onMoveCompensate(nextIndex);
                }
            });
        };
        /**
    ...
    ImageViewer.prototype.loadImage = function (index) {
        ...
        if (this.props.loadingWithBlur) {
            react_native_1.Image.getSize(image.loadingUrl, function (width, height) {
    ...
    ImageViewer.prototype.getContent = function () {
        ...
        var ImageElements = this.props.imageUrls.map(function (image, index) {
            ...
            if (_this.props.loadingWithBlur && width < screenWidth && height < screenHeight) {
                var imageRatio = height / width || 1;
          ...
          {children}
            ...
            var statusNow = imageInfo.status;
            if (_this.props.loadingWithBlur && imageInfo.status !== 'fail') {
            ...
            switch (statusNow) {
              ...
              <react_native_1.View style={_this.styles.loadingContainer}>{_this.props.loadingRender()}</react_native_1.View>
                ...
                case 'success':
                    ...
                    return (<react_native_image_pan_zoom_1.default key={index} 
                    // @ts-ignore
                    ref={function (el) { return (_this.imageRefs[index] = el); }} cropWidth={_this.width} cropHeight={_this.height} maxOverflow={_this.props.maxOverflow} horizontalOuterRangeOffset={_this.handleHorizontalOuterRangeOffset} responderRelease={_this.handleResponderRelease} onLongPress={_this.handleLongPressWithIndex.get(index)} onClick={_this.handleClick} onDoubleClick={_this.handleDoubleClick} imageWidth={width} imageHeight={height} enableSwipeDown={_this.props.enableSwipeDown} swipeDownThreshold={_this.props.swipeDownThreshold} onSwipeDown={_this.handleSwipeDown} pinchToZoom={_this.props.enableImageZoom} enableDoubleClickZoom={_this.props.enableImageZoom} doubleClickInterval={_this.props.doubleClickInterval} onMove={_this.props.onMove}>
              ...
              {_this.props.failImageSource &&
                ...
                case 'loadingWithBlur':
                    ...
                    var scaleWidth = _this.width * _this.currentScale;
                    var scaleHeight = _this.height * _this.currentScale;
                    if (!image.props.style) {
                        image.props.style = {};
                    }
                    image.props.style = __assign(__assign(__assign({}, _this.styles.imageStyle), image.props.style), { width: scaleWidth, height: scaleHeight });
                    var loadingWithBlurProps = {
                        source: image,
                    };
                    if (_this.props.enablePreload) {
                        _this.preloadImage(_this.state.currentShowIndex || 0);
                    ...
                    return (<react_native_image_pan_zoom_1.default key={index} 
                    // @ts-ignore
                    ref={function (el) { return (_this.imageRefs[index] = el); }} cropWidth={_this.width} cropHeight={_this.height} maxOverflow={_this.props.maxOverflow} horizontalOuterRangeOffset={_this.handleHorizontalOuterRangeOffset} responderRelease={_this.handleResponderRelease} onLongPress={_this.handleLongPressWithIndex.get(index)} onClick={_this.handleClick} onDoubleClick={_this.handleDoubleClick} imageWidth={scaleWidth} imageHeight={scaleHeight} enableSwipeDown={_this.props.enableSwipeDown} swipeDownThreshold={_this.props.swipeDownThreshold} onSwipeDown={_this.handleSwipeDown} pinchToZoom={_this.props.enableImageZoom} enableDoubleClickZoom={_this.props.enableImageZoom} doubleClickInterval={_this.props.doubleClickInterval} onMove={_this.onMove}>
              {_this.props.renderLoadingWithBlur(loadingWithBlurProps)}
            </react_native_image_pan_zoom_1.default>);
            }
        });
